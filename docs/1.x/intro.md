...
- [Package installation](/docs/1.x/get-started/installation).
- [Selling on App Store](/docs/1.x/category/app-store/).
- [Selling on Google Play](/docs/1.x/category/google-play-billing).
- [Configuring server notifications](/docs/1.x/category/server-notifications).
- [Credentials](/docs/1.x/category/credentials).
...
the [contribution guide](/docs/1.x/contributing) before creating an issue or pull request.
