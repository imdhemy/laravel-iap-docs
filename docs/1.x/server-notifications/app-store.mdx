...
the URL provided by LIAP. Refer to [Generating signed URLs](/docs/1.x/get-started/routing#generate-a-signed-url) to
learn how to
generate this URL.
...
and other
[routing](/docs/1.x/get-started/routing) parameters.
...
4. Select either version `1` or `2` for the **Version** field.
