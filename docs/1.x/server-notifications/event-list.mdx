...
this guide to learn [how to use them](/docs/1.x/get-started/event-listeners).

## App Store Events

:::success 🎉 New in 1.2.x
...
| **_Did change renewal pref_** `1 & 2`   | `Imdhemy\Purchases\Events\AppStore\DidChangeRenewalPref`   | The customer made a change in their subscription plan that takes effect at the next renewal. The currently active plan isn’t affected.                                                               |
...
| **_Did renew_** `1 & 2`                 | `Imdhemy\Purchases\Events\AppStore\DidRenew`               | Indicates that a customer’s subscription has successfully auto-renewed for a new transaction period.                                                                                                 |
