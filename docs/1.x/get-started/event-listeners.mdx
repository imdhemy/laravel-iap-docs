...
If you enabled the [server notifications](/docs/1.x/category/server-notifications)
...
[specific event](/docs/1.x/server-notifications/event-list) which you can listen to as follows:
