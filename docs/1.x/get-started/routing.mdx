...
the [Server notifications](/docs/1.x/category/server-notifications) from different providers. This route uses a query
...
The generated URLs will be used to receive the [server notifications](/docs/1.x/category/server-notifications).
